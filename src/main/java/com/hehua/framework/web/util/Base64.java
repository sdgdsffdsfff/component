...
public class Base64 {
     ...
     */
    public static String encodeWithHehuaSpec(byte[] data) {
     ...
     * '+' will be replaced with '-','=' will be replaced with '*'
     *
     * @param base64StringWithHehuaSpec data to be decode.
     * @return An array after decode.
     */
    public static byte[] decodeWithHehuaSpec(String base64StringWithHehuaSpec) {
        if (StringUtil.isEmpty(base64StringWithHehuaSpec)) {
            return null;
        }
        try {
            return decode(base64StringWithHehuaSpec.replaceAll("_", "/").replaceAll("-", "+").replaceAll("\\*", "="));
        } catch (Exception e) {
            return null;
        }
    }
