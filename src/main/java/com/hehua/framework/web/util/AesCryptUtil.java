...
public class AesCryptUtil {
    ...
    private static String encrypt(String plainData, String password, boolean caseInsensitive, int confoundSize) {
        ...
        return caseInsensitive ? StringUtil.byte2HexString(cipherDataArray) : Base64.encodeWithHehuaSpec(cipherDataArray);
    }
    ...
    private static String decrypt(String cipherData, String password, boolean caseInsensitive) {
        ...
        byte[] cipherDataArray = caseInsensitive ? StringUtil.hexString2Bytes(cipherData) : Base64.decodeWithHehuaSpec(cipherData);
